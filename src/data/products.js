...
const products = [
  ...
  {
    image: productImage3,
    productId: "M&M's Large Dispenser Red",
    title: "M&M's Large Dispenser Red",
    categoryId: "Burgers",
    lorem: "Great way to make your business appear trust and relevant.",
  ...
  {
    image: productImage4,
    productId: "Large Dispenser M&M's Yellow",
    title: "Large Dispenser M&M's Yellow",
    categoryId: "Burgers",
    lorem: "Great way to make your business appear trust and relevant.",
  ...
  {
    image: productImage5,
    productId: "M&M's Airplane",
    title: "M&M's Airplane",
    categoryId: "Burgers",
    lorem: "Great way to make your business appear trust and relevant.",
  ...
  {
    image: productImage7,
    productId: "Drink Chocolate",
    categoryId: "Burgers",
    title: "Drink Chocolate",
    lorem: "Great way to make your business appear trust and relevant.",
    description: `Clinical research indicates that moderate coffee consumption is benign or mildly beneficial as a stimulant in healthy adults, with continuing research on whether long-term consumption reduces the risk of some diseases, although some of the long-term studies are of questionable credibility.`,
    price: 60,
  },
  ...
  {
    image: drinks1,
    productId: "Drink Chocolate & Peanut Flavuor",
    title: "Drink Chocolate & Peanut Flavuor",
    categoryId: "Drinks",
    lorem: "Great way to make your business appear trust and relevant.",
    description: `Clinical research indicates that moderate coffee consumption is benign or mildly beneficial as a stimulant in healthy adults, with continuing research on whether long-term consumption reduces the risk of some diseases, although some of the long-term studies are of questionable credibility.`,
    price: 26,
  ...
  {
    image: drinks2,
    productId: "Drink Coconut & Peanut Flavuor",
    title: "Drink Coconut & Peanut Flavuor",
    categoryId: "Drinks",
    lorem: "Great way to make your business appear trust and relevant.",
    description: `Clinical research indicates that moderate coffee consumption is benign or mildly beneficial as a stimulant in healthy adults, with continuing research on whether long-term consumption reduces the risk of some diseases, although some of the long-term studies are of questionable credibility.`,
    price: 23,
  ...
  {
    image: drinks4,
    productId: "Drink Chocolate Flavuor",
    categoryId: "Drinks",
    title: "Drink Chocolate Flavuor",
    lorem: "Great way to make your business appear trust and relevant.",
    description: `Clinical research indicates that moderate coffee consumption is benign or mildly beneficial as a stimulant in healthy adults, with continuing research on whether long-term consumption reduces the risk of some diseases, although some of the long-term studies are of questionable credibility.`,
    price: 29,
  },
  ...
  {
    image: add1,
    productId: "Milka Choco Wafer ",
    title: "Milka Choco Wafer ",
  ...
  {
    image: add2,
    productId: "MILKA Cookies Chocolate ",
    title: "MILKA Cookies Chocolate ",
    categoryId: "Additives",
    lorem: "Great way to make your business appear trust and relevant.",
    description: `Clinical research indicates that moderate coffee consumption is benign or mildly beneficial as a stimulant in healthy adults, with continuing research on whether long-term consumption reduces the risk of some diseases, although some of the long-term studies are of questionable credibility.`,
    price: 5,
